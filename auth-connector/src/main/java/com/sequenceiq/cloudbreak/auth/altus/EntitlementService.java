...
import static com.sequenceiq.cloudbreak.auth.altus.model.Entitlement.CDP_DL_LOAD_BALANCER;
...
public class EntitlementService {
    ...
    public boolean datalakeLoadBalancerEnabled(String actorCrn, String accountId) {
        return isEntitlementRegistered(actorCrn, accountId, CDP_DL_LOAD_BALANCER);
    }
