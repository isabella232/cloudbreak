...
public interface EnvironmentEndpoint {
    ...
    void postStartByName(@PathParam("name") String name, @QueryParam("dataHubStartAction") @DefaultValue("ALL") DataHubStartAction dataHubStartAction);
    ...
    void postStartByCrn(@PathParam("crn") String crn, @QueryParam("dataHubStartAction") @DefaultValue("ALL") DataHubStartAction dataHubStartAction);
